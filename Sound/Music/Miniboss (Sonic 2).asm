S2Boss_Header:
	...
	smpsHeaderVoice     S2Boss_Voices
	smpsHeaderChan      $06, $03
	smpsHeaderTempo     $01, $E3

	smpsHeaderDAC       S2Boss_DAC
	smpsHeaderFM        S2Boss_FM1,	$0C, $0A
	smpsHeaderFM        S2Boss_FM2,	$0C, $06
	smpsHeaderFM        S2Boss_FM3,	$0C, $08
	smpsHeaderFM        S2Boss_FM4,	$00, $0F
	smpsHeaderFM        S2Boss_FM5,	$00, $0F
	smpsHeaderPSG       S2Boss_PSG1,	$E8, $04, $00, fTone_0C
	smpsHeaderPSG       S2Boss_PSG2,	$E8, $06, $00, fTone_0C
	smpsHeaderPSG       S2Boss_PSG3,	$FE, $03, $00, fTone_04
...
S2Boss_Jump01:
	smpsNoteFill        $08
	smpsCall            S2Boss_Call02
	smpsNoteFill        $0A

S2Boss_Loop0B:
	dc.b	nE1, $0C, nE2
	smpsLoop            $00, $04, S2Boss_Loop0B
	smpsNoteFill        $08
	smpsCall            S2Boss_Call02
	smpsNoteFill        $0A
...
S2Boss_Loop09:
	...
	smpsLoop            $00, $02, S2Boss_Loop09
	smpsAlterPitch      $F4
	smpsSetvoice        $03

S2Boss_Loop0A:
	smpsCall            S2Boss_Call01
	smpsLoop            $00, $04, S2Boss_Loop0A
	smpsAlterPitch      $0C
	smpsJump            S2Boss_FM2
...
S2Boss_Loop06:
	...
	smpsLoop            $00, $02, S2Boss_Loop06

S2Boss_Loop07:
	dc.b	nRst, $30
	smpsLoop            $00, $10, S2Boss_Loop07
	smpsAlterNote       $03
	smpsAlterVol        $FC

S2Boss_Loop08:
	smpsCall            S2Boss_Call01
	smpsLoop            $00, $02, S2Boss_Loop08
	smpsAlterNote       $00
	smpsAlterVol        $04
	smpsJump            S2Boss_FM3
...
S2Boss_Loop05:
	dc.b	nRst, $30, nRst
	smpsLoop            $00, $04, S2Boss_Loop05
	smpsModOn
	smpsAlterVol        $02
	smpsCall            S2Boss_Call00
	dc.b	nG3
	smpsCall            S2Boss_Call00
...
S2Boss_Loop0D:
	...
	smpsLoop            $00, $02, S2Boss_Loop0D

S2Boss_Loop0E:
	dc.b	nA5, $18
	smpsLoop            $00, $40, S2Boss_Loop0E
	smpsJump            S2Boss_Loop0D
