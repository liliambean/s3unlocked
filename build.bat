...
IF "%1"=="-logerrors" ( "AS\Win32\asw.exe" -xx -q -c -E -A -L -i "%cd%" sonic3k.asm ) ELSE "AS\Win32\asw.exe" -xx -q -c -A -L -i "%cd%" sonic3k.asm

REM // if there were errors, a log file is produced
IF "%1"=="-logerrors" ( IF EXIST sonic3k.log goto LABLERROR3 )

REM // combine the assembler output into a rom
IF EXIST sonic3k.p "AS\Win32\fdp2bin" sonic3k.p s3unlocked.bin sonic3k.h
